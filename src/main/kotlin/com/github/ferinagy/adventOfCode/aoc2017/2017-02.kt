...
private fun part1(input: String) = parse(input).sumOf { it.maxOrNull()!! - it.minOrNull()!! }

private fun part2(input: String) = parse(input).sumOf { processList(it) }

private fun processList(input: List<Int>): Int {
    for (a in input) {
        for (b in input) {
...
private const val testInput1 = """5 1 9 5
7 5 3
2 4 6 8"""

private const val testInput2 = """5 9 2 8
9 4 7 3
3 8 6 5"""
