...
private fun part2(input: String): Int {
    val validRooms = input.lines().map { parse(it) }.filter { it.isValid() }
...
private const val testInput1 = """aaaaa-bbb-z-y-x-123[abxyz]
a-b-c-d-e-f-g-h-987[abcde]
not-a-real-room-404[oarel]
totally-real-room-200[decoy]"""

private const val input = """hqcfqwydw-fbqijys-whqii-huiuqhsx-660[qhiwf]
