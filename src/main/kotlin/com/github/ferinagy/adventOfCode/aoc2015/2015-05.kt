...
private fun part1(input: String): Int {
    return input.lines().count { isNice1(it) }
}

private fun part2(input: String): Int {
    return input.lines().count { isNice2(it) }
}
...
private const val testInput1 = """ugknbfddgicrmopn"""
private const val testInput2 = """jchzalrnumimnmhp"""

private const val input = """zgsnvdmlfuplrubt
vlhagaovgqjmgvwq
ffumlmqwfcsyqpss
zztdcqzqddaazdjp
eavfzjajkjesnlsb
